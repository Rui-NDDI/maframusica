 ...
 * @endcode
 */
$settings['hash_salt'] = 'R99ibJcB1VPfCUum0v_vHgox_15qCQSVA3YMOmx3kCwXW744v3Y2IP9iuTSRyuAsOj-9ZaaWrA';
...
/**
 * Split configuration - Turn OFF everything.
 */
$config['config_split.config_split.dev']['status'] = FALSE;
$config['config_split.config_split.stag']['status'] = FALSE;
$config['config_split.config_split.prod']['status'] = FALSE;

/**
 * Split configuration - Turn ON according our environment.
 */
$config['config_split.config_split.' . $config['laf']['env']]['status'] = TRUE;
...
$databases['default']['default'] = [
  'database' => getenv('SB_MYSQL_DATABASE'),
  'driver' => 'mysql',
  'host' => getenv('SB_MYSQL_HOSTNAME'),
  'namespace' => 'Drupal\\mysql\\Driver\\Database\\mysql',
  'password' => getenv('SB_MYSQL_PASSWORD'),
  'port' => getenv('SB_MYSQL_PORT'),
  'prefix' => '',
...
$config['s3fs.settings']['hostname'] = getenv('S3_CUSTOM_HOST');
$config['s3fs.settings']['use_https'] = TRUE;
$config['s3fs.settings']['root_folder'] = getenv('S3_ROOT_FOLDER');
